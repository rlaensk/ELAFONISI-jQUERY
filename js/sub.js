...
window.addEventListener("scroll", function () {
  let mal1 = window.matchMedia(
    "(min-width:320px) and (max-width:499px)"
  ).matches;
  let mal2 = window.matchMedia(
    "(min-width:500px) and (max-width:766px)"
  ).matches;
  let mal3 = window.matchMedia(
    "(min-width:767px) and (max-width:1200px)"
  ).matches;
  let mal4 = window.matchMedia(
